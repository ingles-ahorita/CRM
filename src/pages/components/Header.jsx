...
function FilterPanel({ state, setState, mode = "full" }) {
  ...
  const update = (updates) =>
    setState && setState((prev) => ({ ...prev, ...updates }));
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            >
              ...
              {safeState.setterMap &&
                Object.entries(safeState.setterMap).map(([id, name]) => (
                  <option key={`setter-${id}`} value={id}>
                    {name}
                  </option>
                ))}
            </select>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            >
              ...
              {safeState.closerMap &&
                Object.entries(safeState.closerMap).map(([id, name]) => (
                  <option key={`closer-${id}`} value={id}>
                    {name}
                  </option>
                ))}
            </select>
          ...
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            ...
            <FilterButton
              ...
              onClick={() => {
                ...
                update({
                  sortBy:
                    sortBy === "purchased_at" ? "book_date" : "purchased_at",
                });
              }}
            />
            <FilterButton
              label="No conversions"
              active={filters.noConversions}
              onClick={() => toggleFilter("noConversions")}
            />
            <FilterButton
              label="Lock In"
  ...
  return (
    ...
    >
      {[
        ...
        .filter((tab) => !(mode === "setter" && tab === "tomorrow"))
        .map((tab) => (
          <button
            key={tab}
            onClick={() => {
              ...
              const shouldClearDates =
                !rangeTabs.includes(tab) && !rangeTabs.includes(activeTab);
              update({
                activeTab: tab,
                searchTerm: "",
                showSearch: false,
                startDate: shouldClearDates
                  ? ""
            ...
            onMouseEnter={(e) => {
              if (activeTab !== tab) e.currentTarget.style.color = "#111827";
            }}
            onMouseLeave={(e) => {
...
function HeaderOrderAndFilters({
  state,
  setState,
  mode = "full",
  filterPanelOpen,
  ...
  return (
    <>
      ...
      >
        {mode === "full" &&
          activeTab !== "tomorrow" &&
          activeTab !== "tomorrow + 1" &&
          sortBy !== "purchased_at" && (
            <>
              <div
                onClick={() =>
                  update({
                    sortBy: sortBy === "book_date" ? "call_date" : "book_date",
                  })
                }
                style={{
                  width: "50px",
        ...
        <button
          onClick={() =>
            update({ sortOrder: sortOrder === "desc" ? "asc" : "desc" })
          }
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter")
                update({ searchTerm: e.target.value, activeTab: "all" });
            }}
            style={{
    ...
    <div style={{ marginTop: "24px" }}>
      ...
      {activeTab === "no shows" && (
        ...
        >
          ...
          <FilterButton
            label="No show"
            active={filters?.noShowState === "no_show"}
            onClick={() =>
              setState &&
              setState((prev) => ({
                ...prev,
                filters: {
                  ...prev.filters,
                  noShowState:
                    prev.filters?.noShowState === "no_show" ? "" : "no_show",
                },
              }))
            }
          />
          <FilterButton
            label="Contacted"
            active={filters?.noShowState === "contacted"}
            onClick={() =>
              setState &&
              setState((prev) => ({
                ...prev,
                filters: {
                  ...prev.filters,
                  noShowState:
                    prev.filters?.noShowState === "contacted"
                      ? ""
                      : "contacted",
                },
              }))
          ...
          <FilterButton
            label="Rebooked"
            active={filters?.noShowState === "rebooked"}
            onClick={() =>
              setState &&
              setState((prev) => ({
                ...prev,
                filters: {
                  ...prev.filters,
                  noShowState:
                    prev.filters?.noShowState === "rebooked" ? "" : "rebooked",
                },
              }))
            }
          />
          <FilterButton
            label="Dead"
            active={filters?.noShowState === "dead"}
            onClick={() =>
              setState &&
              setState((prev) => ({
                ...prev,
                filters: {
                  ...prev.filters,
                  noShowState:
                    prev.filters?.noShowState === "dead" ? "" : "dead",
                },
              }))
            }
          />
                ...
                onClick={() =>
                  ...
                  setState((prev) => ({
                    ...
                    filters: {
                      ...prev.filters,
                      noShowState:
                        prev.filters?.noShowState === "no_show"
                          ? ""
                          : "no_show",
                    },
                  }))
                ...
                onClick={() =>
                  ...
                  setState((prev) => ({
                    ...
                    filters: {
                      ...prev.filters,
                      noShowState:
                        prev.filters?.noShowState === "rebooked"
                          ? ""
                          : "rebooked",
                    },
                  }))
            ...
            <>
                  ...
                  {mode === "full" && (
                    <>
                      ...
                      <button
                        ...
                        onMouseEnter={(e) =>
                          (e.currentTarget.style.backgroundColor = "#f3f39f")
                        }
                        onMouseLeave={(e) =>
                          (e.currentTarget.style.backgroundColor = "#f9ffa6")
                        }
                        onClick={() =>
                          window.open(
                            "https://www.inglesahorita.com/call-reaction-time",
                            "_blank",
                          )
                        }
                      >
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.backgroundColor =
                          state.isShiftActive ? "#fde68a" : "#bbf7d0";
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.backgroundColor =
                          state.isShiftActive ? "#fef3c7" : "#dcfce7";
                      }}
                      onClick={() => {
              ...
              <div
                style={{
                  ...
                  opacity: showFilterPanel ? 1 : 0,
                  transition:
                    "max-height 0.35s ease-out, opacity 0.25s ease-out",
                  marginTop: showFilterPanel ? 0 : -8,
                  marginBottom: showFilterPanel ? 0 : -8,
                }}
              >

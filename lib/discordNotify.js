 ...
 *   ICLOSED_SLA_MINUTES — default 15
...
export function getIclosedSlaMinutes() {
  const raw = parseInt(process.env.ICLOSED_SLA_MINUTES || '15', 10);
 ...
 * @param {{ name?: string | null, phone?: string | null, iclosed_status?: string | null, status?: string | null }} lead
 */

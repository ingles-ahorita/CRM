...
export default async function handler(req, res) {
  ...
  try {
    const [callsRes, outcomeRes, outcomeByCallDateRes, bookingsRes] = await Promise.all([
      supabase
        .from('calls')
    ...
    if (outcomeByCallDateRes.error) console.warn('[management-series] purchases by call_date error', outcomeByCallDateRes.error.message);
    else outcomeLogsByCallDate = outcomeByCallDateRes.data || [];

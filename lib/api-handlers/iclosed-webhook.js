 ...
 *
 * Strategy:
 *   1. Query by email (primary) — filter is_reschedule in JS to avoid PostgREST
 ...
 *
 * Excludes rows where is_reschedule = true so a prior reschedule row is never
 * mistaken for the original booking.
 */
